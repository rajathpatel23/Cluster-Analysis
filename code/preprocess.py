...
def create_vocab_preprocess(stopwords, data, preprocess, process_data=False, vocab={}):
    word_to_file = {}
    word_to_file_mult = {}
...
def create_vocab_and_files(stopwords, dataset, preprocess, type, vocab=None):
    data = None
    if dataset == "20NG":
    ...
    return create_vocab_preprocess(stopwords, data, preprocess)
